...
Download the software from [https://github.com/Sharpiless/Nanocrystals-TEM-segmentation/releases/tag/v2.2](https://github.com/Sharpiless/Nanocrystals-TEM-segmentation/releases/tag/v2.2)
